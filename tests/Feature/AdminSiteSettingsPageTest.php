...
class AdminSiteSettingsPageTest extends TestCase
{
    ...
    public function test_generated_netease_theme_variants_are_listed_with_public_assets(): void
    {
        ...
        $expectedThemes = [
            'geoflow-template-01-ink-editorial' => 'geo.dofe 01 Ink Editorial',
            'geoflow-template-02-market-briefing' => 'geo.dofe 02 Market Briefing',
            'geoflow-template-03-salmon-insight' => 'geo.dofe 03 Salmon Insight',
            'geoflow-template-04-red-opinion' => 'geo.dofe 04 Red Opinion',
            'geoflow-template-05-wire-clean' => 'geo.dofe 05 Wire Clean',
            'geoflow-template-06-public-broadcast' => 'geo.dofe 06 Public Broadcast',
            'geoflow-template-07-breaking-red' => 'geo.dofe 07 Breaking Red',
            'geoflow-template-08-section-blue' => 'geo.dofe 08 Section Blue',
            'geoflow-template-09-tech-spectrum' => 'geo.dofe 09 Tech Spectrum',
            'geoflow-template-10-wired-feature' => 'geo.dofe 10 Wired Feature',
            'geoflow-template-11-product-newsroom' => 'geo.dofe 11 Product Newsroom',
            'geoflow-template-12-saas-gradient' => 'geo.dofe 12 SaaS Gradient',
            'geoflow-template-13-linear-system' => 'geo.dofe 13 Linear System',
            'geoflow-template-14-knowledge-paper' => 'geo.dofe 14 Knowledge Paper',
            'geoflow-template-15-reading-medium' => 'geo.dofe 15 Reading Medium',
            'geoflow-template-16-newsletter-letter' => 'geo.dofe 16 Newsletter Letter',
            'geoflow-template-17-executive-review' => 'geo.dofe 17 Executive Review',
            'geoflow-template-18-consulting-insight' => 'geo.dofe 18 Consulting Insight',
            'geoflow-template-19-tech-review' => 'geo.dofe 19 Tech Review',
            'geoflow-template-20-research-journal' => 'geo.dofe 20 Research Journal',
        ];
