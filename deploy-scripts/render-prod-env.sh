...
required_keys=(
  ...
  MODELS_BASE_URL MODELS_API_KEY MODELS_CHAT_SMOKE_MODEL MODELS_EMBEDDING_SMOKE_MODEL
...
optional_keys=(
  ...
  GEOFLOW_MODELS_ALLOW_INSECURE_LOCAL GEOFLOW_OUTBOUND_PRIVATE_TARGETS
  SSO_INTERNAL_API_URL SSO_DISCOVERY_URL SSO_SERVICE_NAME SSO_SCOPE
  GEOFLOW_MCP_ENABLED GEOFLOW_MCP_TOKEN GEOFLOW_MCP_READ_TOKEN GEOFLOW_MCP_DEFAULT_TENANT GEOFLOW_MCP_ALLOW_CROSS_TENANT GEOFLOW_MCP_URL_IMPORT_MAX_ACTIVE
  GEOFLOW_MCP_ALLOW_SYSTEM_TOKEN GEOFLOW_MCP_GATEWAY_SECRET GEOFLOW_MCP_SERVER_NAME GEOFLOW_MCP_AUDIT_ADMIN_ID
  GEOFLOW_MCP_RATE_LIMIT_PER_MINUTE GEOFLOW_MCP_IP_RATE_LIMIT_PER_MINUTE
)
