...
class DistributionController extends Controller
{
    ...
    {
        $defaultName = trim((string) ($payload['name'] ?? 'geo.dofe.ai Target Site'));
        $defaults = $channel?->resolvedSiteSettings() ?? [
            'site_name' => $defaultName !== '' ? $defaultName : 'geo.dofe.ai Target Site',
            'site_subtitle' => '',
            'site_description' => '由 geo.dofe.ai 自动分发和管理的目标站点。',
            'site_keywords' => '',
            'copyright_info' => '© '.date('Y').' '.($defaultName !== '' ? $defaultName : 'geo.dofe.ai Target Site'),
            'site_logo' => '',
            'site_favicon' => '',
