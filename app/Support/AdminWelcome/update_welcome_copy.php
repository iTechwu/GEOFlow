        ...
        'zh-CN' => [
            ...
            'letter' => [
                ...
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleZh !== '' ? $titleZh : '后台已经检测到 geo.dofe 上游仓库有一个新版本可用。',
                    ],
                    [
                        'type' => 'paragraph',
        ...
        'en' => [
            ...
            'letter' => [
                ...
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleEn !== '' ? $titleEn : 'The admin has detected that a newer geo.dofe release is available in the upstream repository.',
                    ],
                    [
                        'type' => 'paragraph',
